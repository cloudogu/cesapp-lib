...
func (sg *sslGenerator) GenerateSelfSignedCert(fqdn string, domain string, certExpireDays int, country string,
	...
	ca, caPrivateKey, err := sg.createCertTemplateWithKey(certExpireDays, domain, country, province, locality, altDNSNames)
	if err != nil {
	...
	cert, certPrivKey, err := sg.createCertTemplateWithKey(certExpireDays, domain, country, province, locality, altDNSNames)
	if err != nil {
...
func (sg *sslGenerator) createCertTemplateWithKey(validDays int, domain string, country string, province string, locality string, altDNSNames []string) (*x509.Certificate, *rsa.PrivateKey, error) {
